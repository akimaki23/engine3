...
namespace engine {
  namespace ORB {
	...
	class DistributedObjectBroker : public StreamAcceptor, public Singleton<DistributedObjectBroker> {
	...
	public:
		...
		DistributedObjectBrokerClient* createConnection(ServiceSession* session);
