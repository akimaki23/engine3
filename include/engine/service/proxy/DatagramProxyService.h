...
class DatagramProxyService : public DatagramAcceptor {
...
public:
	...
	// client methods
	ServiceSession* createConnection(Socket* sock, SocketAddress& addr);

	void handleMessage(ServiceSession* client, Packet* message);
